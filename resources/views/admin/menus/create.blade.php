                ...
                <form enctype="multipart/form-data" action="{{ route('admin.menus.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea type="text" id="description" name="description"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('description') border-red-400 @enderror"></textarea>
                        @error('description')
                            <div class="alert alert-danger text-red-400 ">{{ $message }}</div>
                        @enderror
                    </div>
