<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            ...
            <span class="inline md:block">Welcome To Abde Restaurant</span>
        </h1>
        ...
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                            One sunny afternoon, a couple stumbled upon a quaint little café called "AbdeForFood" They
                            decided to stop in for a quick lunch and were immediately struck by the charming ambiance
                            and friendly staff.<br>

                            And so, The Daily Grind continued to be a favorite spot for locals and visitors alike,
                            offering a warm and welcoming atmosphere and delicious food to all who stopped by.
                        </p>
                    ...
                    <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                        ...
                        <div class="px-6 py-4">
                            ...
                            <h4 class="mb-3 text-xl font-semibold tracking-tight text-green-600 uppercase">salmon fish 1
                                seafood</h4>
                            <p class="leading-normal text-gray-700">Lorem ipsum dolor, sit amet cons ectetur adipis
                                icing
                                elit.</p>
                        </div>
